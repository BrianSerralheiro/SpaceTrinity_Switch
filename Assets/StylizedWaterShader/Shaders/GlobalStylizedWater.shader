...
Shader "Marc Sureda/GlobalStylizedWater" {
    Properties {
...
//            #define UNITY_PASS_FORWARDBASE
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = float2(mul(unity_ObjectToWorld,v.vertex).x,mul(unity_ObjectToWorld,v.vertex).y+_Time.y*5);
                ...
                float2 node_9794 = (mul(mul(unity_ObjectToWorld,v.vertex).xy-node_9794_piv,float2x2( node_9794_cos, -node_9794_sin, node_9794_sin, node_9794_cos))+node_9794_piv);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 sceneColor = tex2D(Refraction, i.uv0*_MainFoamScale);
